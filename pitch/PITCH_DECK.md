...
Today, 200 million young people across Latin America are being told a story about money. And it is the wrong story. It is a story of exclusion, confusion, and fear.
...
It is already a game. Nobody just built it yet.
...
| Market | 2025 Size | 2030 Projected |
|---|---|---|
| **EdTech (LATAM)** | $3.2B | $8.7B |
| **GameFi (Global)** | $18B | $65B+ |
| **Financial Literacy Tools** | $1.2B | $4.5B |

**Total Addressable Market:** $8.4B (global EdTech gamification + GameFi education)
**Serviceable Market:** $1.8B (LATAM financial literacy + LATAM GameFi)
**Initial Target (Year 5):** $90M (5M active players at $18/user/year blended revenue)

Nobody owns the intersection. That intersection is ours.
...
1. **In-Game Purchases** (B2C)
   - Cosmetic items, premium quests, seasonal passes
   - Non-pay-to-win: paying does not skip learning
   - Target ARPU: $4-8/month

2. **Educational Licenses** (B2B / B2G)
   - Schools, universities, governments license Ludex as a financial literacy platform
   - Dashboard with analytics: track student progress, completion, competency scores
   - Target: $5-15 per student/year at institutional scale

3. **On-Chain Economy**
   - Small transaction fees on reward distributions
   - Credential verification fees for employers and institutions
   - Treasury-funded community incentives

**Unit economics work at 50K active players. We are building for 5 million.**
...
We are not waiting for the market. We are building it.
...
Financial literacy is not a nice-to-have. It is the difference between a generation that builds wealth and a generation that stays trapped.
